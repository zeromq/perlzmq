...
# between releases. Note this assumes the generated file /zmq_msg_sizes
# exists (generated under docker via Dockerfile.zmq-all)
my @zmq_msg_sizes = file('/zmq_msg_sizes')->slurp(chomp => 1);
